  ...
  return (
    <div className="flex h-full flex-col bg-white/72 dark:bg-slate-950/35">
      <div className="px-5 pb-3 pt-6 pr-12 md:pr-5">
        <div className="mb-2 flex items-center gap-2 text-sm font-bold uppercase tracking-[0.18em] text-sky-700 dark:text-sky-300">
          <Layers3 className="size-3.5" />
          Módulo
        </div>
        <h2 className="text-lg font-extrabold tracking-tight text-slate-950 dark:text-white">Simulados</h2>
        <p className="mt-1 text-sm leading-5 text-muted-foreground">Avaliações e banco pedagógico</p>
      </div>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-3" aria-label="Navegação de Simulados">
        ...
        <div className="px-3 pb-1 pt-5 text-sm font-bold uppercase tracking-[0.18em] text-slate-400 dark:text-slate-500">Acesso externo</div>
      ...
      <div className="p-4">
        <div className="rounded-2xl border border-sky-100 bg-sky-50/75 p-3.5 dark:border-sky-900/50 dark:bg-sky-950/35">
          ...
          <p className="mt-2 text-sm leading-4 text-sky-700/80 dark:text-sky-300/75">Questões e avaliações centralizadas para toda a equipe.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className="block truncate text-sm font-medium opacity-65">{description}</span>
      </span>
