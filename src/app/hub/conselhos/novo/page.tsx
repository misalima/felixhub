...
export default function NewCouncilPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try { const council = await councilFetch<{ id: string }>("/api/class-councils", { method: "POST", body: JSON.stringify({ schoolYear: year, term: Number(term), meetingDate }) }); router.push(`/hub/conselhos/${council.id}/importar`); }
