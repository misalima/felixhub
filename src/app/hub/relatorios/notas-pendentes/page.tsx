...
function MissingGradesDocument({ data }: { data: PedagogicalDashboardOverviewData }) {
  ...
  return <>
    ...
    <p className="mt-7 border-t border-slate-300 pt-2 text-sm text-slate-500">Fonte: versão {data.source?.version ?? "—"} do Relatório de Desempenho. Documento gerado pelo Felix Hub.</p>
    <style jsx global>{`
